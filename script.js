  ...
  const script = [
    {
      cmd: '$ whoami',
      output: [
        { t: 'I turn raw data into dashboards and decisions leadership can act on,' },
        { t: 'most recently as a Data Science Intern at Barton Malow.' },
        { t: '5+ years of experience in Data Engineering and Analytics across Oracle' },
        { t: 'and Accenture, currently deepening my analytics and BI foundations at' },
        { t: 'Penn State.' },
      ],
    },
    {
      cmd: '$ git checkout -b add-alzheimers-market-overview',
      output: [{ t: "Switched to a new branch 'add-alzheimers-market-overview'", cls: 't-dim' }],
    },
    {
      cmd: '$ git commit -m "Add Alzheimer\'s Market Overview dashboards"',
      output: [
        { t: '[add-alzheimers-market-overview 6b2f8d1] Add Alzheimer\'s Market Overview dashboards', cls: 't-dim' },
        { t: ' 7 files changed, 2140 insertions(+)', cls: 't-dim' },
      ],
    },
    {
      cmd: '$ git push -u origin add-alzheimers-market-overview',
      output: [{ t: "branch set up to track 'origin/add-alzheimers-market-overview'", cls: 't-dim' }],
    },
    {
      cmd: '$ gh pr create --title "Add Alzheimer\'s Market Overview dashboards"',
      output: [{ t: 'https://github.com/tus2014ar/Alzheimer-s-Market-Overview---United-States/pull/1', cls: 't-url' }],
    },
    {
      cmd: '$ gh pr checks 1',
